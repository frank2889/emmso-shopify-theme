...
Uses centralized performance_expert knowledge base for analysis.
Accesses expert knowledge on Core Web Vitals, Lighthouse, HTTP/2, and modern performance optimization.
...
- Caching strategies
- Mobile performance
- GPT-4 Vision for performance-focused screenshot analysis
"""
import os
import sys
import json
...
from knowledge import performance_expert
...
class MarcusPerformanceAnalyst:
    ...
    def __init__(self):
        ...
        self.knowledge = performance_expert  # Access to centralized knowledge base
